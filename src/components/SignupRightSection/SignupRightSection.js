      ...
      <div className="p-8 w-full max-w-md bg-white rounded-lg">
        ...
        <form className="space-y-4">
         ...
         <div className="relative">
            ...
            />
            <img src="/assets/images/user.png" alt="password" className="absolute top-4 left-3 w-5 h-5" />
          ...
          <div className="relative">
            ...
            />
            <img src="/assets/images/email.png" alt="password" className="absolute top-4 left-3 w-5 h-5" />
          ...
          <div className="relative">
            ...
            />
<img src="/assets/images/password.png" alt="password" className="absolute top-4 left-3 w-5 h-5" />

          </div>
       
          <button
            type="submit"
            className="w-full bg-[#0575E6] text-white p-3 rounded-full"
          >
            Register
          </button>
