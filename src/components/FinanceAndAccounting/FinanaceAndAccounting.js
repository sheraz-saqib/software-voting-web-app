...
const FinanaceAndAccounting = () => {
  ...
  return (
    <div className="bg-[#F0F7FD] text-black w-full h-full max-width py-10 max-lg:py-4 flex flex-col items-center justify-between">
      ...
      <div ref={cardsRef} className="flex flex-row justify-center items-center mt-8 w-[75%] max-lg:w-[95%] gap-4 max-lg:flex-col max-lg:gap-3">
        {/* Left Side */}
        <div className="flex flex-col w-1/2 max-lg:w-full gap-4 max-lg:gap-3">
          {/* Card 1 */}
          <div className="card bg-[#E1E7F0] py-5 text-black rounded-lg p-6 flex flex-col justify-between lg:h-[240px] max-lg:h-[140px] max-lg:p-4">
        ...
        {/* Right Side */}
        <div className="card bg-gradient-to-t from-[#E1E7F0] to-white rounded-lg p-6 w-[40%] max-lg:w-full h-[31rem] max-lg:h-[260px] flex flex-col justify-between relative text-black max-lg:p-4">
      ...
      {/* Full-Width Section */}
      <div className="card bg-white w-[69%] max-lg:w-[95%] pb-4 mt-3 lg:mt-8 relative p-1 rounded-lg flex justify-between max-lg:flex-col">
      ...
      <div ref={userCountRef} className="flex px-8 lg:px-0 justify-center mt-5 py-10 max-lg:pt-6 max-lg:px-4">
        <p className="text-sm md:text-xl">
          More than <span className="text-[#FFB407]">152.78k+</span> users love their financial journey
        </p>
      </div>
      <div ref={swiperRef} className="w-full px-4">
        <Swiper
